...
use App\Http\Controllers\Api\Dashboard\SpecialOffers\BuyGetOfferController;
...
Route::post('/buy-get-offer', [BuyGetOfferController::class, 'store']);
Route::get('all/buy-get-offers', [BuyGetOfferController::class, 'index']);
...
Route::middleware(['auth:sanctum'])->prefix('dashboard')->group(function () {
    ...
    Route::post('/create-all-links', [SocialMediaController::class, 'storeAll']);

    //about-store
    // Route::apiResource('about-store', AboutOurStoreController::class);
    Route::get('/get-about-store', [AboutOurStoreController::class, 'index']);
    Route::post('/create-about-store', [AboutOurStoreController::class, 'store']);
    Route::post('/update-about-store', [AboutOurStoreController::class, 'update']);
    Route::post('/delete-about-store', [AboutOurStoreController::class, 'destroy']);
    ...
    Route::get('/get-reminded-carts', [CartAnalyticsController::class, 'remindedCarts']);

    Route::get('/get-not-reminded-carts', [CartAnalyticsController::class, 'notRemindedCarts']);
...
Route::prefix('website')->middleware(['track.visitors'])->group(function () {
    ...
    Route::apiResource('banners', WebsiteBannerController::class)->middleware('auth:sanctum')->except(['index','show']);
    Route::post('update-banner', [WebsiteBannerController::class, 'updateBanner'])->middleware('auth:sanctum');



    //product-review
    Route::apiResource('/product-review', ProductReviewController::class);
    Route::post('/product-review/create', [ProductReviewController::class, 'storeReview'])->middleware('auth:sanctum');
    ...
    Route::apiResource('brands', WebsiteBrandController::class)->middleware('auth:sanctum')->except(['index','show']);
    Route::post('update-brand', [WebsiteBrandController::class, 'updateBrand'])->middleware('auth:sanctum');

    Route::post('store-brands', [WebsiteBrandController::class, 'storeSeveralBrands'])->middleware('auth:sanctum');

    Route::post('update-brands', [WebsiteBrandController::class, 'updateOrCreateSeveralBrands'])->middleware('auth:sanctum');
    ...
    Route::post('/sections/order', [WebsiteSectionController::class, 'updateOrder'])->middleware('auth:sanctum');
